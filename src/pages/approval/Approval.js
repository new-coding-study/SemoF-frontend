...
function Approval() {
  ...
  return (
    <>
      <div className={ApprovalCSS.title}>전자결재</div>
      <br />
      <div className={ApprovalCSS.outLine}>
        <div className={ApprovalCSS.statistic}>
          <iframe
            src="http://localhost:5601/app/dashboards#/view/23598970-dcc2-11ed-87e5-551937667ac7?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow%2Fd%2Cto%3Anow%2Fd))&hide-filter-bar=true"
            height="600"
            width="800"
          ></iframe>
        </div>
        <div className={ApprovalCSS.menuBox}>
          ...
          <div>
            <button
              className={ApprovalCSS.outBox}
              onClick={() => {
                navigate(`/semof/inbox`);
              }}
            >
              <img
                src={"/images/결재상신.png"}
          ...
          <div>
            <button
              className={ApprovalCSS.inBox}
              onClick={() => {
                navigate(`/semof/outbox`);
              }}
            >
              <img
                src={"/images/결재수신.png"}
          ...
          <div>
            <button
              className={ApprovalCSS.complete}
              onClick={() => {
                navigate(`/semof/complete/in`);
              }}
            >
              <img
                src={"/images/결재완료.png"}
          ...
          <div>
            <button
              className={ApprovalCSS.line}
              onClick={() => {
                navigate(`/semof/lines`);
              }}
            >
              <img
                src={"/images/결재라인.png"}
